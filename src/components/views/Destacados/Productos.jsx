    ...
    <Row className="g-4">
      {posts.map(( post, idx) => (
        <Col xs={12} sm={6} md={4} key={idx}>
          <Card>
            <div>
            <Card.Img className='border-bottom card-destacados-img' variant="top" src={post.imagen} />
            <Card.Title className='text-white title-precio rounded'>${post.precio}</Card.Title>
